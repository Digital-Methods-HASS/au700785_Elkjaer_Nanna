...
```{r eval = FALSE}
kings_denmark <- read_csv2("data/kings_3.csv")
...
This study examines homicides in Europe from 1300 to 2000. One could suggest that a more civilized civilization would see a decrease in homicides. As seen by figure 1 and 2, the amount of homicides i Europe from 1300 to 2000 has massively decreased. This development happens throughout Europe in all the countries which are examined in this study. This suggests that Europeans are more civilized today than they were a few hundred years ago. 
